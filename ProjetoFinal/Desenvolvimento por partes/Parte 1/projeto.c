...
/*-------------------------------------------------------------------------------------
Programa 5 - Laboratório de Algoritmos e Estruturas de Dados 1 - LAEDS
Programa 5 - Busca por padrão em sequência
...
#define QUANTIDADE_DIGITOS_PADRAO 5
...
int main()
{
	...
	int padraoAnalisado[5] = {1,3,2,3,1};			// Mensagem padrão passada no enunciado
